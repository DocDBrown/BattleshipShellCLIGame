...
@test "bs_ai_easy_init_builds_complete_unique_target_list_matching_board_size_count" {
	bs_board_new 5
	# Call directly to ensure global variables are set in the current shell
	bs_ai_easy_init 5 12345

	[ "${BS_AI_EASY_INITIALIZED}" -eq 1 ]

	# 5x5 = 25
	[ "${#BS_AI_EASY_REMAINING_SHOTS[@]}" -eq 25 ]
